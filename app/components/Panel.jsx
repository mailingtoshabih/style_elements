...
export const Panel = ({
    ...
    return (
        <div>
            ...
            <div onClick={copyJsx} className="text-purple-600 text-lg font-semibold my-1 p-3 w-full flex justify-center items-center rounded-xl bg-purple-200 hover:bg-purple-300 cursor-pointer duration-500">
            ...
            <div className="  text-center text-slate-400 text-md font-semibold mt-1 p-1 w-full  rounded-xl bg-slate-200 duration-500">
                
                {"COPY PNG"}
                <p className='text-gray-400 text-xs'>Under Development</p>
            </div>
