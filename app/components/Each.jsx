...
export const Each = ({ icon }) => {
    ...
    return (
        <div>
            ...
            {editIcon &&
                <div>
                    <div onClick={closeEditor} className='hidden sm:flex z-10 overflow-none fixed h-screen top-0 bottom-0 left-0 right-0 w-full items-center justify-center backdrop-blur-[16px] shadow-2xl'>
